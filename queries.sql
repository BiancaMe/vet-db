...
SELECT species, AVG(escape_attempts) FROM animals WHERE species = 'pokemon' AND date_of_birth >= '01/01/1990' AND  date_of_birth <= '01/01/2000'  GROUP BY species UNION SELECT species, AVG(escape_attempts) FROM animals WHERE species = 'digimon' AND date_of_birth >= '01/01/1990' AND  date_of_birth <= '01/01/2000'   GROUP BY species ;
